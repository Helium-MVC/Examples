 ...
 * entities.
 */
class Images extends PGModel {
	
	protected $_schema = array(
		'image_id' =>  array('type' => 'bigint', 'primary_key' => true, 'default' => 'shard_1.id_generator()' , 'execute_default' => true, 'auto_increment' => true),
		//Optional UUID using built-in Postgres OSSP features
		//'image_id' => array('type' => 'uuid', 'primary_key' => true, 'default' => 'uuid_generate_v4()' , 'execute_default' => true, 'auto_increment' => true),
		...
		'image_date_created' => array('type' => 'datetime', 'default' => 'now()'),
		'image_transfered' => array('type' => 'tinyint', 'default' => 0),
		'entity_type' => array('type' => 'string', 'precision' => 25, 'default' => ''),
		'entity_id' => array('type' => 'bigint', 'not_null' => false, 'default' => null),
	);
...
Images::addObserver('app\models\uuid\Images::create', 'read_closure', function($model, $result, $id, $data, $options) {
...
Images::addObserver('app\models\uuid\Images::update', 'read_closure', function($model, $result, $data, $conditions, $options) {
